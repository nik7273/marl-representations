"""
CDCK2 from https://github.com/jefflai108/Contrastive-Predictive-Coding-PyTorch/blob/master/src/model/model.py
"""
...
## CPC Network
## Feed in: sequence of combined images (concatenated image vectors)
